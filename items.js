...
{id:6, name:"X Attack", price:25000, use:"attackBoost", unUse:null, time:60, type:"combat", instant:0, magnitude: 2, flavorText: "Double your Pokemon's attack for 60 seconds!"},
...
var itemsPerRoute = {
    ...
    3: ["X Attack", "X Click", "X Attack", "X Click", "X Attack", "X Attack"],
    ...
    8: ["X Attack", "X Click", "X Attack", "X Click"],
    ...
    21: ["X Attack", "X Exp"],
    22: ["X Click"],
    23: ["Lucky Incense", "Item Magnet"],
    24: ["X Exp", "Lucky Incense"],
